/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1c4add5f302792bbb8f5ba1a20f592a9)
// Runtime types generated with workerd@1.20260601.1 2026-06-04 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	SLACK_APP_TOKEN: string;
	SLACK_BOT_TOKEN: string;
	WORKER_AGENT_URL: string;
	WORKER_CONNECTOR_TOKEN: string;
	AI_GATEWAY_ID: string;
	AI_GATEWAY_COLLECT_LOGS: string;
	AI_GATEWAY_SOURCE: string;
	SLACK_CONVERSATION_AGENT: DurableObjectNamespace<import("./src/cmd/worker").SlackConversationAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cmd/worker");
		durableNamespaces: "SlackConversationAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_APP_TOKEN" | "SLACK_BOT_TOKEN" | "WORKER_AGENT_URL" | "WORKER_CONNECTOR_TOKEN" | "AI_GATEWAY_ID" | "AI_GATEWAY_COLLECT_LOGS" | "AI_GATEWAY_SOURCE">> {}
}
